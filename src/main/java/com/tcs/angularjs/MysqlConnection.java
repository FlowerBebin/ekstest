...
public class MysqlConnection{
  ...
  private static String connection = "jdbc:mysql://staging-money-transfer.cyresrdwhvat.us-west-1.rds.amazonaws.com/crosspayMT"; //'milon' is your database name
  private static String user = "admin";                  //'root' is username
  private static String password = "AfNyt7metAuiadwBT8rL";        //'pass' is password
